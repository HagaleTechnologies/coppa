...
Until stage 1 is done, the honest one-line status for a sysop is: *"Simulated only; SSB-realistic ladder tops out at ≈0.95 kbps user at the daemon's shipped defaults; does not yet hold a link through CCIR-Moderate fading."*

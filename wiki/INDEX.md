...
- [What will bite you about this repo's agent tooling (Serena and humanlayer thoughts)?](pages/agent-tooling.md) — `.serena/project.yml` gives catalyst-dev's subagents real symbol search instead of

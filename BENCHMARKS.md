...
Watterson-Poor never clears the FER≤10%/1% Wilson-CI bar at any tested SNR for any mode
except a marginal 21 dB point on the lowest-rate BPSK codes on the Moderate channel above —
Poor shows a genuine irreducible outage floor from real ensemble-Rayleigh flat fading: e.g.
BPSK 1/4 FER holds at 24.5–28.5% and BPSK 1/2 at 41–45% across 24–30 dB (see
`results/rebaseline-2026-07/poor.csv`), confirming deep fades now cost real receive power
